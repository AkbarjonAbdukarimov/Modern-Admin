...
export const Vendors = () => {
  ...
  const columns: GridColDef[] = [
        ...
        <Link to={`/vendors/${params.id}`}>
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M3 6C3 5.44772 3.44772 5 4 5H5C5.55228 5 6 5.44772 6 6C6 6.55228 5.55228 7 5 7H4C3.44772 7 3 6.55228 3 6ZM8 6C8 5.44772 8.44772 5 9 5H20C20.5523 5 21 5.44772 21 6C21 6.55228 20.5523 7 20 7H9C8.44772 7 8 6.55228 8 6ZM3 12C3 11.4477 3.44772 11 4 11H5C5.55228 11 6 11.4477 6 12C6 12.5523 5.55228 13 5 13H4C3.44772 13 3 12.5523 3 12ZM8 12C8 11.4477 8.44772 11 9 11H20C20.5523 11 21 11.4477 21 12C21 12.5523 20.5523 13 20 13H9C8.44772 13 8 12.5523 8 12ZM3 18C3 17.4477 3.44772 17 4 17H5C5.55228 17 6 17.4477 6 18C6 18.5523 5.55228 19 5 19H4C3.44772 19 3 18.5523 3 18ZM8 18C8 17.4477 8.44772 17 9 17H20C20.5523 17 21 17.4477 21 18C21 18.5523 20.5523 19 20 19H9C8.44772 19 8 18.5523 8 18Z"
              fill="#FED501"
            />
          </svg>
        </Link>
    ...
    },
    {
      ...
      width: 150,
      renderCell: (params) => (
        <Link to={`/vendors/edit/${params.id}`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        >
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4ZM2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM9.17153 9.17156C9.56205 8.78104 10.1952 8.78104 10.5857 9.17156L12 10.5858L13.4142 9.17157C13.8047 8.78105 14.4379 8.78105 14.8284 9.17157C15.219 9.5621 15.219 10.1953 14.8284 10.5858L13.4142 12L14.8284 13.4142C15.2189 13.8047 15.2189 14.4379 14.8284 14.8284C14.4379 15.2189 13.8047 15.2189 13.4142 14.8284L12 13.4142L10.5858 14.8284C10.1953 15.219 9.5621 15.219 9.17157 14.8284C8.78105 14.4379 8.78105 13.8047 9.17157 13.4142L10.5858 12L9.17153 10.5858C8.78101 10.1952 8.78101 9.56208 9.17153 9.17156Z"
              fill="#FF1C1C"
            />
          </svg>
        </Link>
